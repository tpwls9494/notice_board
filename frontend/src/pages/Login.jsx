...
function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-paper-100 bg-noise">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-ink-950 relative overflow-hidden items-center justify-center">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md animate-fade-up">
          ...
          <div className="lg:hidden text-center mb-10">
            ...
            <h1 className="font-display text-2xl font-bold text-ink-950">사내 게시판</h1>
          </div>

          <div>
            <h2 className="font-display text-2xl font-bold text-ink-950 tracking-tight">
              로그인
            </h2>
          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            {error && (
              <div className="flex items-center gap-2 px-4 py-3 bg-red-50 border border-red-200 rounded-xl animate-scale-in">
